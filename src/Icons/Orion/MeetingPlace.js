...
export default function MeetingPlace(props) {
  return (
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 65 65"  aria-labelledby="title" aria-describedby="desc" width={24} height={24} {...props}>
      ...
      <path strokeWidth={4} strokeMiterlimit={10} stroke="currentColor" fill="none" d="M45.3 30a25.5 25.5 0 00.5-3.1v-.4c.1-.7.1-1.4.1-2.1A22.2 22.2 0 0024 2 22.2 22.2 0 002 24.4c0 .7 0 1.5.1 2.2v.3C3.9 44.5 24 58 24 58a65.2 65.2 0 007.2-5.9" data-name="layer2" strokeLinejoin="round" strokeLinecap="round" />

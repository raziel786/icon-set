...
export default function Guide(props) {
  return (
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 65 65"  aria-labelledby="title" aria-describedby="desc" width={24} height={24} {...props}>
      ...
      <path data-name="layer1" fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={4} d="M54 26l-6-4-6 4V4h12v22zm-44-8h14m-14 8h14m-14 8h14m-14 8h14m16-8h14m-14 8h14" strokeLinejoin="round" strokeLinecap="round" />
    </svg>
  );
}
